...
program6 = load_program("Q6_Answer.txt")
...
def start_program6():
    start_program(program6, "Program 6")
...
def register_hotkeys():
    ...
    for combo in combos_6:
        keyboard.add_hotkey(combo, start_program6, suppress=True)
...
print("Press Shift+6 or Command+6 / Ctrl+6 -> Program 6")
